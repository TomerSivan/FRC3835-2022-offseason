...
public class AutonomousOneBallPickup extends SequentialCommandGroup {
  ...
  public AutonomousOneBallPickup(DriveBase driveBase, ShooterBase shooterBase, LimelightBase limelightBase, IntakeBase intakeBase, StorageSubsystem storageSubsystem) {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(new CollectBall(this.intakeBase, this.storageSubsystem),new DriveForward(this.driveBase), new WaitCommand(1.8)),
      ...
      new ParallelRaceGroup(new Turn180Degrees(this.driveBase),new WaitCommand(3)),
      ...
      new ParallelRaceGroup(new DriveForward(this.driveBase),new WaitCommand(1.5)),
      ...
      new ParallelRaceGroup(new ShootAuto(this.shooterBase, Constants.shootingFromHubVelocityAuto),new WaitCommand(1.5)),
      ...
      new ParallelCommandGroup(new InstantCommand(()->this.storageSubsystem.setTopStorage()),new WaitCommand(1.7)),
